...
export class ERC20__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class ERC20__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class ERC20 extends ethereum.SmartContract {
  ...
  burn(to: Address): ERC20__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new ERC20__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<ERC20__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ERC20__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  devFee(): BigInt {
    let result = super.call("devFee", "devFee():(uint32)", []);

    return result[0].toBigInt();
  }

  try_devFee(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("devFee", "devFee():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getReserves(): ERC20__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new ERC20__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<ERC20__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
